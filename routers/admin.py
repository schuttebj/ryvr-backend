...
async def reset_and_initialize_system(
    ...
    **Usage Examples:**
    ...
    try:
        ...
        # OpenAI uses System Integration (not dynamic) - configured once by admin, used by all businesses
        # This is already created in init_db.py create_default_integrations()
        logger.info("OpenAI system integration already created - uses hardcoded integration (not dynamic)")
        results.append("✅ OpenAI system integration configured - uses hardcoded approach")
